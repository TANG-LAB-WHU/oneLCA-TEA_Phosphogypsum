...
class MACEPredictor:
    ...
    def is_available(self) -> bool:
        ...
        if self._available is None:
            self._available = find_spec("mace.calculators") is not None
    ...
    def predict_property(
        self, smiles: str, property_type: str, temperature_k: float = 298.15
    ) -> Optional[float]:
        """
...
class PropertyPredictor:
    ...
    def get_property(
        self, smiles: str, property_name: str, temperature_k: float = 298.15
    ) -> PropertyPrediction:
        """
