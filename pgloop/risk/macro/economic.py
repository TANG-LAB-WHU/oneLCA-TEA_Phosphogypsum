...
class EconomicRisk:
    ...
    def assess(
        ...
        # Overall score
        score = 0.20 * monetary_score + 0.30 * credit_score + 0.30 * fx_score + 0.20 * macro_score
        ...
        return RiskScore.from_score(
            ...
            factors=factors,
            description=(
                f"{country}: Inflation={inflation_rate:.1%}, "
                f"FX_vol={currency_volatility:.0%}, Rate={credit_rating}"
            ),
