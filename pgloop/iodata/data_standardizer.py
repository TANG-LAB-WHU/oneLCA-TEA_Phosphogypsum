...
class DataStandardizer:
    ...
    def standardize_composition(
        self, data: Dict[str, Any], source: str = "", country: str = "global"
    ...
    def standardize_lci(
        ...
        """
        result = {"inputs": [], "outputs": [], "emissions": []}
    ...
    def _standardize_flow(self, name: str, data: Dict, source: str) -> StandardizedData:
    ...
    def calculate_quality_score(
        self, source_type: str, year: int, geographic_match: bool, technology_match: bool
    ) -> float:
        """
...
def main():
    ...
    composition = {"CaSO4": 0.92, "P2O5": [0.005, 0.015], "Ra226": 500, "Cd": 0.5}  # range

    result = standardizer.standardize_composition(
        composition, source="Literature Review 2024", country="China"
    )
