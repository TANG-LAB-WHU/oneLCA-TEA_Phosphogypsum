...
class BasePathway(ABC):
    ...
    def get_scaled_inventory(self, functional_unit_kg: float, parameters: Dict = None) -> Dict:
        """
    ...
    def copy_with_modified_parameter(self, parameter: str, factor: float) -> "BasePathway":
