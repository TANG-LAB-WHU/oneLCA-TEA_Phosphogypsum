...
class REEExtractionPathway(BasePathway):
    ...
    def _build_inventory(self) -> LifeCycleInventory:
        ...
        ree_yield_kg_kg = (p["ree_content_ppm"] / 1e6) * p["leaching_efficiency"] * p["purification_efficiency"]
    ...
    def get_opex_data(self) -> Dict:
        ...
        return {
            "materials": [
                ...
                {"name": "NaOH", "quantity": p["sodium_hydroxide_kg_per_t"], "price": 0.45, "unit": "kg"},
                {"name": "Extractants", "quantity": p["extractant_l_per_t"], "price": 12.0, "unit": "L"},
            ],
            "utilities": {
    ...
    def get_products(self) -> List[Dict]:
        """Mixed REE products."""
        p = self.parameters
        ree_yield_kg_t = (p["ree_content_ppm"] / 1000) * p["leaching_efficiency"] * p["purification_efficiency"]
        return [
            {
