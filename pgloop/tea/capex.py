...
class CAPEXCalculator:
    ...
    def calculate_installed_cost(
        self, equipment_cost: float, installation_factor: float = None
    ) -> float:
        """
    ...
    def calculate_total(self, capex_data: Dict) -> float:
        ...
        indirect_costs = 0.0
        for factor_name in ["instrumentation", "piping", "electrical", "buildings", "site_prep"]:
    ...
    def annualize(
        self, total_capex: float, discount_rate: float = None, lifetime: int = None
    ) -> float:
        """
    ...
    def calculate_breakdown(self, capex_data: Dict) -> Dict[str, float]:
        ...
        breakdown["total"] = (
            breakdown["total_equipment"] + breakdown["total_indirect"] + breakdown["land"]
        )
