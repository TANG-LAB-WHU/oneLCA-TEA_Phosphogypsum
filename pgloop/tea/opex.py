...
class OPEXCalculator:
    ...
    def estimate_from_capex(self, capex_total: float, annual_throughput: float) -> Dict:
        """
        ...
        return {"fixed_annual": fixed_annual, "per_tonne_fixed": per_tonne, "breakdown": estimates}
