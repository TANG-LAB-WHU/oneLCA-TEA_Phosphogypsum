...
class RegionalContext:
    ...
    energy_mix: Dict[str, float] = field(default_factory=lambda: {
        "coal": 0.30, "gas": 0.25, "nuclear": 0.15, 
        "hydro": 0.15, "solar": 0.10, "wind": 0.05
    })
...
class ScenarioAnalyzer:
    ...
    def analyze(
        ...
        for pathway_name, base_metrics in pathways.items():
            ...
            for scenario in all_scenarios:
                ...
                pathway_results.append(ScenarioResult(
        ...
        for pathway_name, results in analysis_results.items():
            ...
            if values:
                ...
                robustness[pathway_name] = {
                    ...
                    "cv": (sum((v - mean)**2 for v in values) / len(values)) ** 0.5 / abs(mean) if mean else 0,
    ...
    def best_region_for_pathway(
        ...
        results_with_context = [
            r for r in analysis_results[pathway_name] if r.context is not None
        ]
