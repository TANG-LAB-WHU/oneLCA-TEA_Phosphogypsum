...
class ParetoAnalyzer:
    ...
    def _dominates(self, a: Dict[str, float], b: Dict[str, float], criteria: List[str]) -> bool:
        """
    ...
    def find_pareto_front(self, solutions: Dict[str, Dict[str, float]]) -> List[ParetoSolution]:
        """
    ...
    def get_pareto_optimal(self, solutions: Dict[str, Dict[str, float]]) -> List[str]:
    ...
    def calculate_crowding_distance(
        self, solutions: Dict[str, Dict[str, float]], pareto_names: List[str]
    ) -> Dict[str, float]:
        """
        ...
        for crit in criteria:
            ...
            sorted_names = sorted(pareto_names, key=lambda n: solutions[n].get(crit, 0))
