...
from pgloop.decision.mcda import TOPSIS, WeightedSum
...
class PathwayRanker:
    ...
    def rank(self, pathways: Dict[str, Dict[str, float]]) -> List[Recommendation]:
        """
    ...
    def _generate_explanation(self, rec: Recommendation, metrics: Dict[str, float]) -> str:
    ...
    def generate_summary(self, recommendations: List[Recommendation]) -> Dict:
        ...
        return {
            ...
            "pareto_optimal_pathways": [
                r.pathway_name for r in recommendations if r.is_pareto_optimal
            ],
