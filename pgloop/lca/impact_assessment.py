...
class ImpactAssessment:
    ...
    def _calculate_category(self, inventory: Dict, category: str) -> float:
    ...
    def normalize(self, impacts: Dict[str, float], reference: str = "EU27") -> Dict[str, float]:
        """
    ...
    def weight(
        self, normalized_impacts: Dict[str, float], weights: Dict[str, float] = None
    ) -> float:
        """
        ...
        total = sum(
            normalized_impacts.get(cat, 0) * weights.get(cat, 0) for cat in normalized_impacts
        )
