...
from pgloop.risk.aggregator import RiskScore, RiskLevel
from pgloop.decision.scenario import Scenario, ScenarioAnalyzer, MARKET_SCENARIOS
...
def run_integrated_analysis():
    ...
    for pathway in pathways:
        ...
        sample_risks = [
            ...
            RiskScore.from_score("policy", "regulatory_stringency", 45, description="Environmental law")
        ]
